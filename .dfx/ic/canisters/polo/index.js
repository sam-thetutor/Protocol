...
import { idlFactory } from './polo.did.js';
export { idlFactory } from './polo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_POLO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./polo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the polo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./polo.did.js")._SERVICE>}
 */
export const polo = createActor(canisterId);
